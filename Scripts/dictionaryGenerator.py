...
with open('reuters21578/reuters_dictionary_min2000', 'w') as dictionary_output:
    print('saving reuters_dictionary_min2000')
...
with open('reuters21578/reuters_dictionary_max2000', 'w') as dictionary_output:
    print('saving reuters_dictionary_max2000')
    dictionary_output.write(str(new_soup))
