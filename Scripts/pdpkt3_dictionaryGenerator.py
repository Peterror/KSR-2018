...
with open("reuters21578/reuters3_train") as fp:
    print("Opened reuters21578/reuters3_train")
...
with open('reuters21578/reuters3_dictionary_min2000', 'w') as dictionary_output:
    print('saving reuters3_dictionary_min2000')
...
with open('reuters21578/reuters3_dictionary_max2000', 'w') as dictionary_output:
    print('saving reuters3_dictionary_max2000')
    dictionary_output.write(str(new_soup))
